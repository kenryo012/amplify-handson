...
export default function ApplicationUpdateForm(props) {
  ...
  const [applicant, setApplicant] = React.useState(initialValues.applicant);
  ...
  const resetStateValues = () => {
    const cleanValues = applicationRecord
      ...
      : initialValues;
    setApplicant(cleanValues.applicant);
      ...
      <TextField
        ...
        onChange={(e) => {
          ...
          if (onChange) {
            ...
            value = result?.applicant ?? value;
          }
          if (errors.applicant?.hasError) {
            runValidationTasks("applicant", value);
          }
          setApplicant(value);
        }}
        onBlur={() => runValidationTasks("applicant", applicant)}
        errorMessage={errors.applicant?.errorMessage}
        hasError={errors.applicant?.hasError}
